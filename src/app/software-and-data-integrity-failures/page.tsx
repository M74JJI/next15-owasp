...
export default function SoftwareAndDataIntegrityLanding() {
  useEffect(() => {
  ...
  return (
    <main className="min-h-screen bg-black p-8 md:p-16 flex flex-col items-center justify-center overflow-hidden relative">
      ...
      <section className="w-full max-w-3xl space-y-8 relative z-10">
        ...
        >
          Software and Data Integrity Failures Demo
        </motion.h1>
        ...
        >
          ...
          >
            <Link
              href="/software-and-data-integrity-failures/vulnerable"
            ...
            >
              ...
              <p className="text-green-200 leading-relaxed">
                Loads external scripts or updates without verifying signatures
                or integrity checks, exposing the app to malicious code
                injection.
              </p>
            </Link>
          </motion.div>
          ...
          >
            <Link
              href="/software-and-data-integrity-failures/secure"
            ...
            >
              ...
              <p className="text-green-200 leading-relaxed">
                Verifies signatures or checksums before loading external code or
                updates, preventing malicious modifications.
              </p>
            </Link>
          </motion.div>
        </motion.div>
