...
export default function IdentificationAuthLanding() {
  useEffect(() => {
  ...
  return (
    <main className="relative min-h-screen bg-black overflow-hidden flex flex-col justify-center items-center px-4">
      ...
      <section className="w-full max-w-3xl space-y-8 relative z-10 text-center">
        ...
        >
          Identification & Authentication Failures Demo
        </motion.h1>
        ...
        >
          ...
          >
            <Link
              href="/identification-authentication-failures/vulnerable"
              ...
              aria-label="Go to Vulnerable Login Demo"
            >
              <h2 className="text-2xl font-semibold text-red-600 mb-2">
                Vulnerable Authentication
              </h2>
              <p className="text-green-200 leading-relaxed">
                Simulates insecure login flow without password hashing, no
                account lockout, and insecure tokens.
              </p>
            </Link>
          </motion.div>
          ...
          >
            <Link
              href="/identification-authentication-failures/secure"
              ...
              aria-label="Go to Secure Login Demo"
            >
              <h2 className="text-2xl font-semibold text-green-400 mb-2">
                Secure Authentication
              </h2>
              <p className="text-green-200 leading-relaxed">
                Demonstrates secure password hashing, account lockout after
                failed attempts, and JWT token usage.
              </p>
            </Link>
          </motion.div>
        </motion.div>
