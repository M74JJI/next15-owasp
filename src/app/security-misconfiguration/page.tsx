...
export default function SecurityMisconfigurationLanding() {
  useEffect(() => {
    ...
    <main className="relative min-h-screen bg-black overflow-hidden flex flex-col justify-center items-center px-4">
      ...
      <section className="w-full max-w-3xl space-y-8 relative z-10 text-center">
        ...
        >
          ...
          >
            <Link
              href="/security-misconfiguration/vulnerable"
            ...
            >
              ...
              <p className="text-green-200 leading-relaxed">
                Default or incorrect security settings leave your app exposed to
                attacks.
              </p>
            </Link>
          </motion.div>
          ...
          >
            <Link
              href="/security-misconfiguration/secure"
            ...
            >
              ...
              <p className="text-green-200 leading-relaxed">
                Properly configured security settings prevent misconfiguration
                vulnerabilities.
              </p>
            </Link>
          </motion.div>
